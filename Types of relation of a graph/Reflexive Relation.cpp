...
int main()
{
	...
	{
		printf("\n\n\n=====================================================\n");
		printf("Sorry! a [NULL] set cannot hold [Reflexive Relation ]\n");
		printf("=====================================================\n");
		exit(0);
	}
...
//---------------------------->> copying the content of vertex (v1 and v2) into a array B[] <<--------------------
	char *a, *b;
	for(int i= 0; i<sbq; i++)
	{
		a= edges[i].v1.name;
...
//---------------------------->> Printing the element of array set A[] <<-----------------------------------------
	printf("================================================\n");
...
//---------------------------------->> Main Mechanism <<---------------------------------------------------------
	...
	{
		printf("\n===============================================\n");
		printf("|         It holds [reflexive relation ]      |\n");
		printf("===============================================\n");
	}
	else
	{
		printf("\n================================================\n");
		printf("| Sorry! it doesn't holds [reflexive relation] |\n");
		printf("================================================\n");
	}
//----------------------------------------------------------------------------------------------------------------	
